...
//         new Popelushka('ira',22,39),
//         new Popelushka('yra',25,38),
//         new Popelushka('olya',27,37),
//         new Popelushka('lesya',28,36),
//         new Popelushka('zorya',29,35),
//         new Popelushka('anya',21,40),
//         new Popelushka('dia',20,41)
// ];
...
//   }
// }
// const prince = new Princ('Tommy',28,40);
...
//
// const atLast = popelushkaArray.find((item) => item.footsize === prince.findShose);
// console.log(atLast);
